...
import WimmelBlider from './WimmelBlider';
import WinnerPage from './WinnerPage';
import getTargets from '../assets/data';
    ...
    <div className='Game'>
      ...
      <div className='gameboard'>
        ...
        { isEnd ? 
          ...
          : 
          <WimmelBlider targetList={targetList} handleClickOnMenu={handleClickOnMenu} isClicked={isClicked} setClicked={setClicked} />
        }
      </div>
    </div>
  );
